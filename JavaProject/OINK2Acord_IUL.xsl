					...
					<Holding id="Holding_1">
						...
						<Policy>
							...
							<xsl:choose>
								...
								<xsl:when test="./instanceData/TXLife/A_PaymentMode = '9'">
									<PaymentMethod tc="1">Single Premium</PaymentMethod><!-- BHFD-1699 Changed TC value from 20 to 1  -->
								</xsl:when>
							</xsl:choose>
							<xsl:if
							...
							<Life>
								...
								<LifeUSA>
									...
									<!-- BHFD-1681 -->
									<xsl:if test="(./instanceData/TXLife/A_PriorMECInd) = '1'">
							...
							<ApplicationInfo>
								...
								<SignatureInfo id="SignatureInfo_1">
									...
									<!-- Updated by Puja -->
									<!-- BHFD-2070 START -->
									<xsl:if test="./instanceData/TXLife/A_SignatureState != '-1'">
										<SignatureState>
											<xsl:attribute name="tc">
												<xsl:value-of select="instanceData/TXLife/A_SignatureState" />
											</xsl:attribute>
											<xsl:value-of select="instanceData/TXLife/A_SignatureState_Desc" />			
										</SignatureState>
									</xsl:if>
									<!-- BHFD-2070 END -->
								</SignatureInfo>
						...
						<xsl:if test="./instanceData/TXLife/A_EFT_MPREM= '7'">
							<Banking id="Banking_1">
								<!-- BHFD-2411 START commented out as per new requirement -->
								<!-- <xsl:if test="./instanceData/TXLife/A_PremPayor = '1'">Payor is Proposed Insured
									<xsl:attribute name="FinancialInstitutionPartyID">Party_PINS</xsl:attribute>
								</xsl:if>
								<xsl:if test="./instanceData/TXLife/A_PremPayor = '2' and ./instanceData/TXLife/A_OwnerTypeLife_OWN1 = '100' ">Payor is Owner as individual
									<xsl:attribute name="FinancialInstitutionPartyID">Party_OWN1</xsl:attribute>
								</xsl:if>
								<xsl:if test="./instanceData/TXLife/A_PremPayor = '2' and ./instanceData/TXLife/A_OwnerTypeLife_OWN1 != '100' ">Payor is Owner as Entity
									<xsl:attribute name="FinancialInstitutionPartyID">Party_ENTITY1</xsl:attribute>
								</xsl:if>
								<xsl:if test="./instanceData/TXLife/A_PremPayor = '3'">Payor is Other
									<xsl:attribute name="FinancialInstitutionPartyID">Party_PYR</xsl:attribute>
								</xsl:if> -->
								<!-- BHFD-2411 END  -->
								<BankAcctType>
									<xsl:attribute name="tc">
									...
									<xsl:if
										...
										<Holding>
											...
											<Policy>
												...
												<!-- BHFD-1522 - moved OLifEExtension inside Policy object - Start-->												
											...
											<!-- BHFD-1522 - moved OLifEExtension inside Policy object - End-->	
											</Policy>											
										</Holding>
									</xsl:if>
									<xsl:if
					...
					<xsl:if test="string-length(./instanceData/TXLife/A_FirstName_PINS)>0">
						<Party id="Party_PINS">
							...
							<Address id="Address_PINS">
								...
								<!-- BHFD-3141  -->
								<xsl:if	test="string-length(./instanceData/TXLife/A_AddressLine1_PINS) > 0 or
								string-length(./instanceData/TXLife/A_AddressLine2_PINS) > 0 or
								string-length(./instanceData/TXLife/A_AddressLine3_PINS) > 0 or
								string-length(./instanceData/TXLife/A_AddressLine4_PINS) > 0 or 
								string-length(./instanceData/TXLife/A_City_PINS) > 0 or 
								string-length(./instanceData/TXLife/A_State_PINS_Desc) > 0">
								...
								<xsl:if test="$pos != '' and $posValue &lt;= $agentValue">
									<xsl:if
										...
										<Party>
											...
											<Producer>
												<!-- AMERNBA-1776 --><!-- BHFD-1285 -->
												<xsl:if test=" ../*[name()='A_ApplicationJurisdiction'] = '12' and string-length(../*[name()=concat('A_LicenseNoFL_AGT',$pos)])>0 ">
													<License>
														<xsl:attribute name="id">
									...
									<xsl:if
										...
										<Party>
											...
											<Address>
												...
												<!-- BHFd-3141  -->
												<xsl:if test="string-length(../*[name()=concat('A_AddressLine1_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_AddressLine2_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_AddressLine3_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_AddressLine4_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_City_OWN',$pos)]) > 0 or 
															(../*[name()=concat('A_State_OWN',$pos)] != '-1' and 
															string-length(../*[name()=concat('A_State_OWN',$pos,'_Desc')]) > 0 ) or  
															string-length(../*[name()=concat('A_ZipCode_OWN',$pos)]) > 0">
												<OLifEExtension ExtensionCode="Address 2.8.90" VendorCode="05">
													<AddressExtension>
														<ZipCodeTC tc="1">United States Zip + 4</ZipCodeTC>
													</AddressExtension>
										...
										<xsl:if
											...
											<Party>
												...
												<Address>
													...
													<xsl:if test="string-length(../*[name()=concat('A_CustAddressLine1_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_CustAddressLine2_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_CustAddressLine3_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_CustAddressLine4_OWN',$pos)]) > 0 or
															string-length(../*[name()=concat('A_CustCity_OWN',$pos)]) > 0 or 
															(../*[name()=concat('A_CustState_OWN',$pos)] != '-1' and 
															string-length(../*[name()=concat('A_CustState_OWN',$pos,'_Desc')]) > 0 ) or  
															string-length(../*[name()=concat('A_CustZipCode_OWN',$pos)]) > 0">
													<OLifEExtension ExtensionCode="Address 2.8.90" VendorCode="05">
														<AddressExtension>
															<ZipCodeTC tc="1">United States Zip + 4</ZipCodeTC>
														</AddressExtension>
						...
						<Party id="Party_PYR">
							...
							<Address id="PYR">
								...
								<xsl:if	test="string-length(./instanceData/TXLife/A_AddressLine1_PYR) > 0 or
											...
											string-length(./instanceData/TXLife/A_State_PYR_Desc) > 0 or
					...
					<xsl:if
						...
						<Party id="Party_3rdPartyNotif">
							...
							<Address id="Address_3rdPartyNotif">
								...
								<Line3>
									<xsl:value-of select="instanceData/TXLife/A_AddressLine4_TPN1" />
								</Line3>
								<City>
								...
								<!-- BHFD-3141  -->
								<xsl:if	test="string-length(./instanceData/TXLife/A_AddressLine1_TPN1) > 0 or
								string-length(./instanceData/TXLife/A_AddressLine2_TPN1) > 0 or
								string-length(./instanceData/TXLife/A_AddressLine3_TPN1) > 0 or
								string-length(./instanceData/TXLife/A_AddressLine4_TPN1) > 0 or 
								string-length(./instanceData/TXLife/A_City_TPN1) > 0 or 
								string-length(./instanceData/TXLife/A_State_TPN1_Desc) > 0 or 
								string-length(./instanceData/TXLife/A_Zip_TPN1) > 0 ">
								<OLifEExtension ExtensionCode="Address 2.8.90" VendorCode="05">
									<AddressExtension>
										<ZipCodeTC tc="1">United States Zip + 4</ZipCodeTC>
									</AddressExtension>
